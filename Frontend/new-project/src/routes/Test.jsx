...
export default function AdvancedFilterDemo() {
    ...
    // const namaVendorArray = data?.map((item) => ({ namaVendor: item.namaVendor }));
    // console.log(namaVendorArray);
    // const [representatives] = useState(namaVendorArray);
    ...
    const initFilters = () => {
        setFilters({
            ...
            // namaProjek: { constraints: [{ value: null, matchMode: FilterMatchMode.CONTAINS}]  },
            namaProjek: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.CONTAINS }] },
            // 'country.name': { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
            // representative: { value: null, matchMode: FilterMatchMode.IN },
            tanggalPo: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.CONTAINS }] },
    ...
    const representativeBodyTemplate = (rowData) => {
        ...
        return (
            <div className="flex align-items-center gap-2">
                <span>{representative.namaVendor}</span>
            </div>
        );
        // return (
        //     <div className="flex align-items-center gap-2">
    ...
    return (
        <div className="card">
            <DataTable value={data} paginator showGridlines rows={10} loading={loading} dataKey="id" 
                    filters={filters} 
                    globalFilterFields={['namaProjek', 'kodeProjek']} header={header}
                    emptyMessage="No customers found.">
                        {/* {columns?.map((col, i) => (
                            <Column key={col.field} field={col.field} header={col.header} />
                        ))} */}
                <Column header="Kode Projek" field="kodeProjek" style={{ minWidth: '12rem' }} 
                ...
                <Column field="namaProjek" header="Nama Projek" filter filterPlaceholder="Search by nama projek" style={{ minWidth: '12rem' }} />
                {/* <Column header="Nama Vendor" filterField="representative" showFilterMatchModes={false} filterMenuStyle={{ width: '14rem' }} style={{ minWidth: '14rem' }}
                    body={representativeBodyTemplate} filter filterElement={representativeFilterTemplate} /> */}
                <Column header="Date" filterField="tanggalPo" dataType="date" style={{ minWidth: '10rem' }} body={dateBodyTemplate} filter filterElement={dateFilterTemplate} />
